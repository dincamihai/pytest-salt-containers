# -*- coding: utf-8 -*-
#
# pytest-containers documentation build configuration file, created by
...
project = u'pytest-containers'
copyright = u'2015, Mihai Dinca'
author = u'Mihai Dinca'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-containers Documentation',
     [author], 1)
]
